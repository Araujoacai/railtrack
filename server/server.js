...
app.use(helmet({
    contentSecurityPolicy: {
        directives: {
            ...
            connectSrc: ["'self'", "wss:", "ws:", "https://router.project-osrm.org", "https://nominatim.openstreetmap.org", "https://overpass-api.de", "https://overpass.kumi.systems", "https://unpkg.com", "https://*.basemaps.cartocdn.com"],
        },
    },
}));
